...
if (isset($_POST['doPost']) and $_POST['doPost'] == "true") {
    ...
    if ($subject[$new_sub] != '0') {
        echo "<script> alert('您已报名该课程，请勿重复报名，如有问题请联系我们。');</script>";
    } else if (($new_sub == 1 and $subject[0] == 1) or ($new_sub == 0 && $subject[1] == 1)) {
        echo "<script> alert('“微积分（一）”与“微积分（二）”时间冲突！');</script>";
    } else if (($new_sub == 5 and $subject[6] == 1) or ($new_sub == 6 && $subject[5] == 1)) {
        echo "<script> alert('“中国通史（古代部分）”与“电路基础”时间冲突！');</script>";
    } else if (($new_sub == 4 and $subject[7] == 1) or ($new_sub == 7 && $subject[4] == 1)) {
        echo "<script> alert('“中国古代⽂化”与“计算概论（上机）”时间冲突！');</script>";
    } else {
        // move_uploaded_file($_FILES["file"]["tmp_name"],  "./uploaded_forms_" . $_POST['subjectt'] . "/" . "$idcardnum" . ".jpg") 
        // or die("无法保存您的学习证明，请联系jet@pku.edu.cn.");
        $subject[$new_sub] = '1';
        ...
        echo "<script> alert('成功报名考试！'); window.top.location.href = 'info.php'; </script>";
    }
}
?>
        ...
        <div class="mainCon">
            <div class="leftNav">
                <ul>
                    ...
                    <li><a id="Nav_application" class="leftNav_li_selected" href="application.php">报名考试</a></li>
            ...
            <div class="rightContent">
                    <form method="post" name="form1" enctype="multipart/form-data" onSubmit="JavaScript: return checkForm();">
                        ...
                        <table class=app_table>
                            ...
                            <tr>
                                <td align="center" colspan=2><input value="提交考试申请" type="submit" class="submit_button"></td>
                            </tr>
                        </table>
                    </form>
                </div>
